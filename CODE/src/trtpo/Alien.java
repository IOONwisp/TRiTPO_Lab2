...
public abstract class Alien extends JPanel implements MouseListener, Creature {
    ...
    public Alien(Rectangle frames, int frameLivingLimit, int x, int y, java.awt.Color b) {
    ...
    public void setFrames(Rectangle frames, int frameLivingLimit) {
        this.alien = frames;
    ...
    public void paint(Graphics g) {
        ...
        if (isAlive()){
            g2d.setBackground(c);
            g2d.drawRect((int)alien.getX(),(int)alien.getY(),(int)alien.getWidth(),(int)alien.getHeight());}
            //g2d.drawImage(alien[currentFrame], 0, 0, null);
        else
        {/*setForeground(new Color(0, 0, 0, 0));*/among--;}
    }
